...
import {
  History, Star, Workflow, Clock, ChevronRight,
  Trash2, Play, Search, Layers, FileText,
  X, Loader2,
} from "lucide-react";
...
type Tab = "history" | "assets" | "sessions";
...
export function MemoryPanel({
  ...
  const TABS: Array<{ key: Tab; label: string; icon: typeof History }> = [
