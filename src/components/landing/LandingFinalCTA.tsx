...
export function LandingFinalCTA({ ctaAction }: Props) {
  ...
  return (
    <section className="relative overflow-hidden py-32 sm:py-44" aria-label="Get started">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[hsl(var(--gold-oxide)/0.035)] rounded-full blur-[180px]" />
      </div>
      <div className="relative max-w-2xl mx-auto px-5 sm:px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 mb-12">
          <Button size="lg" onClick={ctaAction} className="gap-2.5 px-10 h-[52px] sm:h-14 min-h-[48px] bg-[hsl(var(--gold-oxide))] hover:bg-[hsl(var(--gold-dim))] text-[hsl(var(--obsidian))] font-semibold shadow-lg shadow-[hsl(var(--gold-oxide)/0.18)] w-full sm:w-auto rounded-lg transition-all duration-200">
