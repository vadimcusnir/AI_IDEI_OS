...
import { Plus, Loader2, Search, Filter, Brain, Download, PanelLeftClose, PanelLeft } from "lucide-react";
      ...
      <div className="h-12 border-b border-border bg-card flex items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <button
            ...
            title={showFolders ? "Ascunde foldere" : "Arată foldere"}
          >
            ...
            {selectedFolderId && selectedFolderId !== "__unassigned" && (
              <div className="flex items-center gap-2 mb-3">
                <span className="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded-full">
                  Folder selectat · {filteredCount} neuroni
                </span>
                <button onClick={() => setSelectedFolderId(null)} className="text-[10px] text-muted-foreground hover:text-foreground">
                  ✕ Arată toți
                </button>
              </div>
            )}
