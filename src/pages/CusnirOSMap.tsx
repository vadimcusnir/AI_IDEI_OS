...
const nodes: MapNode[] = [
  ...
  { id: "nota_doi", label: "NOTADOI.COM", sublabel: "Anti Școală — Dezvoltare Personală", layer: "platform", layerName: "STRAT 4 — PLATFORME & PRODUSE", x: CX + 170, y: CY + 580, desc: "Platforma Nota Doi — „Anti Școală" pentru dezvoltare personală.", details: ["Podcast Nota Doi cu invitați", "Codul mAInd — curs AI gratuit", "Pay What You Want model"] },
  ...
  { id: "podcast_nota_doi", label: "PODCAST NOTA DOI", sublabel: "Anti Școală", layer: "channels", layerName: "STRAT 7 — CANALE & DISTRIBUȚIE", x: CX - 200, y: CY - 680, desc: "Podcastul Nota Doi — format de interviu.", details: ["„Anti Școală" — întrebări care distrug convenții", "Lead generation → Codul mAInd"] },
