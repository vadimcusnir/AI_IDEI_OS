        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }} custom={0} variants={fadeUp}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-3 sm:space-y-4 text-sm text-[hsl(var(--ivory-dim)/0.6)] leading-relaxed">
                ...
                <div className="pl-4 border-l-2 border-[hsl(var(--signal-red)/0.2)] space-y-1.5 text-xs text-[hsl(var(--ivory-dim)/0.4)] py-1">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-2.5 sm:gap-3">
                {["too many ideas", "weak positioning", "slow writing", "unclear offers", "inconsistent content", "scattered execution"].map(item => (
                  <div key={item} className="flex items-center gap-2 text-[11px] sm:text-xs text-[hsl(var(--ivory-dim)/0.45)]">
