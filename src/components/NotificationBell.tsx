    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 sm:right-0 top-10 z-50 w-[calc(100vw-2rem)] sm:w-80 max-w-80 bg-card border border-border rounded-xl shadow-xl overflow-hidden">
