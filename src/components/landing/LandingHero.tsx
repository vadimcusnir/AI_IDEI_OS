    ...
    <section ref={heroRef} className="relative overflow-hidden" aria-label="Hero">
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-6 pt-24 sm:pt-36 md:pt-44 pb-10 sm:pb-20 text-center">
        ...
        <motion.p
          ...
          className="text-[10px] sm:text-[11px] font-mono tracking-[0.35em] uppercase text-[hsl(var(--gold-oxide))] mb-10 sm:mb-12"
        >
          {t("hero.tagline")}
        </motion.p>
        ...
        <motion.h1
          ...
          className="text-[clamp(2.25rem,5.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.02em] text-foreground mb-7 sm:mb-8"
        >
          {t("hero.title_prefix")}{" "}
        ...
        <motion.p
          ...
          className="text-[15px] sm:text-lg text-muted-foreground leading-[1.75] max-w-[580px] mx-auto mb-12 sm:mb-16 px-2"
        >
          {t("hero.subtitle")}
        </motion.p>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 mb-20 sm:mb-24 px-4 sm:px-0"
        >
          <Button
            size="lg"
            onClick={ctaAction}
            className="cta-glow gap-2.5 text-sm font-semibold px-10 h-[52px] sm:h-14 bg-[hsl(var(--gold-oxide))] hover:bg-[hsl(var(--gold-dim))] text-[hsl(var(--obsidian))] shadow-lg shadow-[hsl(var(--gold-oxide)/0.18)] w-full sm:w-auto min-h-[48px] rounded-lg transition-all duration-200"
          >
            {t("hero.cta_start")}
