    ...
    <section className="py-32 sm:py-44" aria-label="Why AI-IDEI is different">
      <ContentBoundary width="default">
        <FadeInView className="mb-20 sm:mb-24">
          <span className="text-eyebrow font-mono tracking-[0.3em] text-[hsl(var(--gold-oxide))] mb-6 block">{t("why_different.label")}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px rounded-xl overflow-hidden bg-border/50 mb-24">
          ...
          <FadeInView delay={0.12} className="bg-card relative p-8 sm:p-10">
            ...
            <span className="text-eyebrow font-mono tracking-[0.25em] text-[hsl(var(--gold-oxide))] mb-8 block relative">{t("why_different.with_label")}</span>
        ...
        {/* Pull quote */}
        <FadeInView className="max-w-2xl mx-auto text-center py-12 sm:py-16 border-y border-[hsl(var(--gold-oxide)/0.12)]">
