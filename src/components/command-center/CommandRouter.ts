...
const INTENT_PATTERNS: IntentPattern[] = [
  {
    ...
    services: ["deep_analysis", "content_analyzer", "psychology_profiler"],
  ...
  },
  {
    ...
    services: ["neuron_extractor", "framework_extractor", "pattern_finder"],
    requiredTier: "authenticated",
    baseCredits: 350,
  ...
  },
  {
    ...
    services: ["content_generator", "article_writer", "social_writer"],
    requiredTier: "authenticated",
    baseCredits: 150,
  ...
  },
  {
    ...
    services: ["search_neurons", "knowledge_search"],
    requiredTier: "authenticated",
    baseCredits: 20,
  ...
  },
  {
    ...
    services: ["comparator", "contradiction_detector"],
    requiredTier: "pro",
    baseCredits: 400,
  ...
  },
  {
    ...
    services: ["psychology_profiler", "guest_profiler"],
    requiredTier: "pro",
    baseCredits: 500,
  ...
  },
  {
    ...
    slashCommands: ["/pipeline", "/workflow", "/batch"],
    services: ["pipeline_runner", "batch_executor"],
    requiredTier: "pro",
    baseCredits: 800,
    label: "Multi-Step Pipeline",
    description: "Execute multi-agent workflows and automation chains",
  },
  {
    category: "status",
