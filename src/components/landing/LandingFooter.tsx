...
function FooterLink({ to, children }: { to: string; children: React.ReactNode }) {
  return (
    <Link to={to} className="text-sm text-[hsl(var(--ivory-dim)/0.5)] hover:text-[hsl(var(--gold-oxide)/0.9)] transition-colors focus-ring rounded">
      {children}
    </Link>
  );
}
...
export function LandingFooter() {
  return (
    <footer className="border-t border-[hsl(var(--ivory-dim)/0.08)] bg-[hsl(var(--obsidian))]">
      <div className="mx-auto max-w-5xl px-5 sm:px-6 py-12 sm:py-16">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4 col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <p className="max-w-[200px] text-sm text-[hsl(var(--ivory-dim)/0.5)] leading-relaxed">
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-mono tracking-[0.12em] text-[hsl(var(--ivory-dim)/0.6)] uppercase">Platform</h3>
          ...
          {/* Resources */}
          <div className="space-y-3">
            <h3 className="text-xs font-mono tracking-[0.12em] text-[hsl(var(--ivory-dim)/0.6)] uppercase">Resources</h3>
            <ul className="space-y-2.5">
          ...
          {/* Community */}
          <div className="space-y-3">
            <h3 className="text-xs font-mono tracking-[0.12em] text-[hsl(var(--ivory-dim)/0.6)] uppercase">Community</h3>
            <ul className="space-y-2.5">
          ...
          {/* Legal */}
          <div className="space-y-3">
            <h3 className="text-xs font-mono tracking-[0.12em] text-[hsl(var(--ivory-dim)/0.6)] uppercase">Legal</h3>
            <ul className="space-y-2.5">
        ...
        {/* Bottom bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[hsl(var(--ivory-dim)/0.08)] pt-6 sm:flex-row">
          <span className="text-xs font-mono text-[hsl(var(--ivory-dim)/0.4)]">
