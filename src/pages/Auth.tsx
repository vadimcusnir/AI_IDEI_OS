        ...
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          {mode !== "forgot" && (
            <>
              ...
              }} className="w-full h-10 flex items-center justify-center gap-2 rounded-lg border border-input bg-background hover:bg-muted/50 transition-colors text-sm font-medium">
          ...
          <div className="mt-4 space-y-2 text-center">
            {mode === "login" && (
              <>
                ...
                <button onClick={() => setMode("signup")} className="text-xs text-muted-foreground hover:text-primary transition-colors block mx-auto">Don't have an account? Create one</button>
              </>
            )}
            {mode === "signup" && <button onClick={() => setMode("login")} className="text-xs text-muted-foreground hover:text-primary transition-colors">Already have an account? Sign in</button>}
