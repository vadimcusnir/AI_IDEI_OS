        ...
        <FadeInView>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div>
              ...
              <h2 className="heading-2 text-[hsl(var(--ivory))] mb-5 sm:mb-6">
                Most people do not struggle with ideas. They struggle with turning ideas into assets.
              </h2>
              <div className="space-y-3 sm:space-y-4 text-base text-[hsl(var(--ivory-dim)/0.7)] leading-relaxed">
                <p>You have thoughts. Notes. Drafts. Angles. Offers. Half-built campaigns. Fragments of good copy.</p>
                <p className="font-semibold text-[hsl(var(--ivory))]">But the real bottleneck is not creativity. It is execution.</p>
                <div className="pl-4 border-l-2 border-[hsl(var(--signal-red)/0.25)] space-y-1.5 text-sm text-[hsl(var(--ivory-dim)/0.55)] py-1">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-2.5 sm:gap-3">
                {["too many ideas", "weak positioning", "slow writing", "unclear offers", "inconsistent content", "scattered execution"].map(item => (
                  <div key={item} className="flex items-center gap-2 text-sm text-[hsl(var(--ivory-dim)/0.6)]">
            ...
            <div className="relative">
              ...
              <div className="mt-6 sm:mt-8 space-y-3">
                {["write faster", "sharpen your message", "build stronger offers", "create more content from one idea", "turn scattered thinking into commercial assets"].map(item => (
                  <div key={item} className="flex items-center gap-3 text-base text-[hsl(var(--ivory))]">
