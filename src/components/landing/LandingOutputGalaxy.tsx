    ...
    <section id="outputs" className="py-32 sm:py-44 border-y border-border/50 relative" aria-labelledby="outputs-heading">
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-6">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }} custom={0} variants={fadeUp} className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-[15px] text-muted-foreground max-w-[480px] mx-auto leading-[1.75]">{t("output_galaxy.subtitle")}</p>
        </motion.div>
        <OutputGalaxy />
        <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp} className="text-center mt-14 text-[10px] sm:text-[11px] font-mono tracking-[0.2em] uppercase text-[hsl(var(--gold-oxide)/0.6)]">
