  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {isNearLimit && (
          <Badge variant="destructive" className="text-nano gap-1">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="font-mono text-dense">{filesPercent.toFixed(1)}%</span>
        </div>
      ...
      {buckets.length > 0 && (
        <div className="space-y-1.5 pt-2 border-t border-border">
          ...
          {buckets.map((b) => (
            <div
              key={b.bucket_id}
              className="flex items-center justify-between text-dense py-1"
            >
