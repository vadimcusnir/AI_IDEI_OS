...
const LearningPage = lazyRetry(() => import("@/pages/LearningPage"));
...
export function protectedRoutes() {
  return (
    <>
      ...
      <Route path="/my-analytics" element={<ProtectedRoute><AppLayout><ErrorBoundary fallbackTitle="Analytics failed to load"><MyAnalytics /></ErrorBoundary></AppLayout></ProtectedRoute>} />
      <Route path="/learning" element={<ProtectedRoute><AppLayout><ErrorBoundary fallbackTitle="Learning failed to load"><LearningPage /></ErrorBoundary></AppLayout></ProtectedRoute>} />
